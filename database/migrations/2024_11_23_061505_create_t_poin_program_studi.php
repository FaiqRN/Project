...
return new class extends Migration
{
    ...
    {
        Schema::create('t_poin_program_studi', function (Blueprint $table) {
            $table->id('poin_program_studi_id');
            $table->unsignedBigInteger('jabatan_id');
            $table->unsignedBigInteger('kegiatan_program_studi_id');
    ...
    {
        Schema::dropIfExists('t_poin_program_studi');
    }
};
