...
return new class extends Migration
{
    ...
    {
        Schema::create('t_kegiatan_jurusan', function (Blueprint $table) {
            $table->id('kegiatan_jurusan_id');
            $table->unsignedBigInteger('surat_id');
            $table->unsignedBigInteger('user_id');

            $table->string('nama_kegiatan_jurusan', 200);
    ...
    {
        Schema::dropIfExists('t_kegiatan_jurusan');
    }
};
